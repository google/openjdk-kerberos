...
public abstract class VersionHelper {
    ...
    final static String[] PROPS = new String[] {
        krb.javax.naming.Context.INITIAL_CONTEXT_FACTORY,
        krb.javax.naming.Context.OBJECT_FACTORIES,
        krb.javax.naming.Context.URL_PKG_PREFIXES,
        krb.javax.naming.Context.STATE_FACTORIES,
        krb.javax.naming.Context.PROVIDER_URL,
        krb.javax.naming.Context.DNS_URL,
