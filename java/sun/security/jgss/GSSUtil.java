...
public class GSSUtil {
    ...
    private static Subject sGlobalSubject = null;

    public static void setGlobalSubject(Subject subject) {
        sGlobalSubject = subject;
    }

    public static Subject getGloballySetSubject() {
        return sGlobalSubject;
    }
     ...
     * property krb.javax.security.auth.useSubjectCredsOnly to false.
     */
